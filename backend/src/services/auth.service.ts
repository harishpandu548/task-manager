...
type JwtAccessPayload = { id: string; email: string; role: Role };
type JwtRefreshPayload = { id: string };
...
export const authService = {
  ...
  async refreshTokens(currentRefreshToken: string) {
    try {
      const decoded = jwt.verify(currentRefreshToken, env.jwt.refreshSecret) as {
        id: string;
      };
